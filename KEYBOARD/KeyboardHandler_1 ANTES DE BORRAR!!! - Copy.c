...
////Variables for MODO-> FireOnKeyPressed + Repetitibilidad 
//static volatile byte v_smachine_Reptt[_MAX_NUMERO_DE_GRUPOS_], *pv_smachine_Reptt;
//static volatile byte v_CountKeepTimming[_MAX_NUMERO_DE_GRUPOS_], *pv_CountKeepTimming;
//
////Variables for MODO-> FireAtTimeExpired
//static volatile word v_Count_FireAtTimeExpired[_MAX_NUMERO_DE_GRUPOS_], *pv_Count_FireAtTimeExpired;
//static volatile byte v_smachine_ModeShoot_FireAtTimeExpired[_MAX_NUMERO_DE_GRUPOS_], *pv_smachine_ModeShoot_FireAtTimeExpired;
				//
...
//pv_smachine_Reptt = &v_smachine_Reptt[CountGroup];
//pv_CountKeepTimming = &v_CountKeepTimming[CountGroup];
////___________________________________________________________________________________________
			//
////MODO-> FireAtTimeExpired
////___________________________________________________________________________________________
//pv_Count_FireAtTimeExpired = &v_Count_FireAtTimeExpired[CountGroup];
//pv_smachine_ModeShoot_FireAtTimeExpired = &v_smachine_ModeShoot_FireAtTimeExpired[CountGroup];
////___________________________________________________________________________________________
	//
			if (*pv_smachine_x_group == 0)	
			{
				...
				while (1)
				{
					temp=	 BitsQconfGrupo[CountGroup][iElemIntoGroup];
					
					if ( temp == END_OF_GROUPn ) {break;}

//Variables for MODO-> FireOnKeyPressed + Repetitibilidad 
//___________________________________________________________________________________________
pv_smachine_Reptt = &v_smachine_Reptt[temp];
pv_CountKeepTimming = &v_CountKeepTimming[temp];
				
//Variables for MODO-> FireOnKeyPressed + NOT Repetitibilidad 
//___________________________________________________________________________________________
pv_smachine_FireOnKeyPressed_NOT_Repett = &v_smachine_FireOnKeyPressed_NOT_Repett[temp];
				
//Variables for MODO-> FireOnKeyPressedAndKeyRelease
//___________________________________________________________________________________________
pv_smachine_FireOnKeyPressedAndKeyRelease = &v_smachine_FireOnKeyPressedAndKeyRelease[temp];				
				
//MODO-> FireAtTimeExpired
//___________________________________________________________________________________________
pv_Count_FireAtTimeExpired = &v_Count_FireAtTimeExpired[temp];
pv_smachine_ModeShoot_FireAtTimeExpired = &v_smachine_ModeShoot_FireAtTimeExpired[temp];
				
					
					//_iNumElemInVect_	= BitsQconfGrupo[CountGroup][iElemIntoGroup] >>3; //div x 8//el cociente.
					//_bit_shift_ = BitsQconfGrupo[CountGroup][iElemIntoGroup] - (_BYTE_WIDTH_*_iNumElemInVect_);

_iNumElemInVect_	= temp >>3; //div x 8//el cociente.
_bit_shift_ = temp - (_BYTE_WIDTH_*_iNumElemInVect_);				
...
//
	...
	******************************************************************/
	void HighLevel(void)
	{
		...
		//....................................................................................
		//Setting x repett
		SettingBitsInRegister(vModeTimmingReptt[0],0,0,0,0,0,0,1,1);		//key8-key1
